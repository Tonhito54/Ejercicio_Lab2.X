;UNINVERSIDAD PEDAGOGICA Y TECNOLOGICA DE COLOMBIA
;MICROCONTROLADORES
;INGRID CATHERIN MORALES CORREA
;2017
;ESTADO: FUNCIONANDO

;TEMPORIZADORES DE DIVERSOS VALORES CARGADOS DESPUES DE UN ESTADO ITERATIVO DE ESPERA
;UNA VEZ LLEGA A CERO CONTINUA CONTANDO NEGATIVAMENTE
;CADA TEMPORIZADOR CUENTA CON UN MENSAJE FINAL DE RESET
;USO DE LCD Y TECLADO
